...
for (let i = 1; i <= TOTAL_IMAGES; i++) {
  ...
  img.alt = `Gallery ${num}`;
  img.loading = 'lazy';
  img.setAttribute('data', 'pop'); // lightbox

  // <a> cuma wrapper menuju gambar asli
  const a = document.createElement('a');
  a.href = `https://res.cloudinary.com/dpawix5pp/image/upload/f_auto,q_auto/gallery-${num}.avif`;
  a.appendChild(img);
